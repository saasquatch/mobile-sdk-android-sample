...
public class WelcomeActivity extends Activity {
    ...
    public void shareFacebook(View shareButton) {
        ...
        shareIntent.putExtra(android.content.Intent.EXTRA_TEXT, mUser.shareLinks.get("facebook"));
    ...
    public void shareTwitter(View shareButton) {
        ...
        shareIntent.putExtra(android.content.Intent.EXTRA_TEXT, "Sign up for a SaaS accoutn and we both get 10% off our SaaS with link: " + mUser.shareLinks.get("twitter"));
